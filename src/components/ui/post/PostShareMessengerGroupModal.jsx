...
export function PostShareMessengerGroupModal({
  ...
  return (
    <div className="fixed inset-0 z-[130] flex items-center justify-center bg-black/55 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-2xl bg-card-dark text-slate-100 border border-border-dark shadow-xl overflow-hidden">
        ...
        <div className="px-4 pt-3 pb-4 space-y-3">
          <div>
            <input
              ...
              className="w-full rounded-lg bg-background-dark/70 border border-border-dark px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary"
            />
          </div>
                        ...
                        return (
                          ...
                          >
                            <img
                              src={avatar}
                              alt={name}
                              className="w-9 h-9 rounded-full object-cover bg-background-dark"
                            />
          ...
          <div className="flex items-center justify-end gap-2 pt-1">
            <button
              type="button"
              onClick={onClose}
              className="px-3 py-1.5 rounded-lg text-xs font-semibold text-slate-200 bg-background-dark/70 border border-border-dark hover:bg-background-dark"
            >
            ...
            <button
              ...
              onClick={onSend}
              className="px-3 py-1.5 rounded-lg text-xs font-semibold text-background-dark bg-primary hover:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {t('messages.send') || 'Gui'}
            </button>
          </div>
