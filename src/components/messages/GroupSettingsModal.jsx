...
export function GroupSettingsModal({ t, open, onClose, selected, currentUserId, onSuccess }) {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-card-dark rounded-xl shadow-2xl w-full max-w-2xl border border-slate-200 dark:border-border-dark flex flex-col overflow-hidden"
      ...
      >
        ...
        <div className="flex flex-1 min-h-0">
          <div className="w-44 shrink-0 border-r border-slate-200 dark:border-border-dark py-2 flex flex-col gap-0.5 bg-slate-50 dark:bg-transparent">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                type="button"
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className={`w-full border rounded-xl py-2.5 px-4 text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 outline-none ${
                    canEditInfo
                      ? 'bg-slate-50 dark:bg-card-dark border-slate-200 dark:border-border-dark focus:ring-2 focus:ring-primary'
                      : 'bg-slate-100 dark:bg-white/5 border-slate-200 dark:border-border-dark cursor-not-allowed opacity-90'
                  }`}
                />
              </div>
              ...
              <div>
                ...
                {canEditMaxMembers ? (
                  ...
                  <p className="text-sm text-slate-600 dark:text-gray-300 py-1">
              ...
              {isHost ? (
                <>
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 cursor-pointer">
                      <input
                        type="checkbox"
                      ...
                      />
                      <span className="text-sm text-slate-800 dark:text-gray-200">{t('messages.permAdminCanKick')}</span>
                    </label>
                    <label className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="rounded border-slate-300 dark:border-gray-500 text-primary focus:ring-primary"
                      />
                      <span className="text-sm text-slate-800 dark:text-gray-200">{t('messages.permAdminCanAddMembers')}</span>
                    </label>
                    <label className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="rounded border-slate-300 dark:border-gray-500 text-primary focus:ring-primary"
                      />
                      <span className="text-sm text-slate-800 dark:text-gray-200">{t('messages.permAdminCanEditGroupInfo')}</span>
                    </label>
                    <label className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="rounded border-slate-300 dark:border-gray-500 text-primary focus:ring-primary"
                      />
                      <span className="text-sm text-slate-800 dark:text-gray-200">{t('messages.permAdminCanAssignUserPermissions')}</span>
                    </label>
                    <label className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="rounded border-slate-300 dark:border-gray-500 text-primary focus:ring-primary"
                      />
                      <span className="text-sm text-slate-800 dark:text-gray-200">{t('messages.permAdminCanBlockUser')}</span>
                    </label>
                  </div>
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 cursor-pointer">
                      <input
                        ...
                        className="rounded border-slate-300 dark:border-gray-500 text-primary focus:ring-primary"
                      />
                      <span className="text-sm text-slate-800 dark:text-gray-200">{t('messages.permUserCanAddMembers')}</span>
                    </label>
                    <label className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="rounded border-slate-300 dark:border-gray-500 text-primary focus:ring-primary"
                      />
                      <span className="text-sm text-slate-800 dark:text-gray-200">{t('messages.permUserCanEditGroupInfo')}</span>
                    </label>
                  </div>
                </>
            ...
            <div className="space-y-4">
              ...
              {canBlock && membersCanBlock.length > 0 && (
                <div>
                  ...
                  <ul className="mt-2 space-y-1 max-h-40 overflow-y-auto rounded-xl border border-slate-200 dark:border-border-dark bg-slate-50 dark:bg-card-dark/50 p-2">
                    {membersCanBlockFiltered.length === 0 ? (
                      ...
                      membersCanBlockFiltered.map((m) => (
                        <li key={m.userId}>
                          ...
                          >
                            <div className="w-9 h-9 rounded-full overflow-hidden bg-slate-200 dark:bg-white/10 shrink-0">
                              {m.avatar ? (
                            ...
                            <span className="text-sm text-slate-800 dark:text-gray-200 truncate flex-1">{m.name || 'User'}</span>
              ...
              <div>
                ...
                {blockedMembers.length === 0 ? (
                  <div className="rounded-xl border border-slate-200 dark:border-border-dark bg-slate-50 dark:bg-card-dark/50 p-6 text-center">
                  ...
                  <ul className="space-y-1 max-h-48 overflow-y-auto rounded-xl border border-slate-200 dark:border-border-dark bg-slate-50 dark:bg-card-dark/50 p-2">
                    {blockedMembers.map((m) => (
                      <li key={m.userId} className="flex items-center justify-between gap-2 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5">
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          <span className="text-sm text-slate-800 dark:text-gray-200 truncate">{m.name || 'User'}</span>
                        </div>
                        <button
                          type="button"
