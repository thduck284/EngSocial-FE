import { FRIEND_FILTER_OPTIONS } from '../../constants/search'
    ...
    <div className="space-y-6 bg-white dark:bg-card-dark p-6 rounded-[2rem] border border-slate-200 dark:border-border-dark shadow-xl shadow-slate-200/50 dark:shadow-none">
      ...
      <div className="flex flex-col gap-3 pt-6 border-t border-slate-100 dark:border-white/5">
        <button
          ...
          className="w-full bg-primary hover:brightness-110 h-11 rounded-xl text-[10px] font-black uppercase tracking-widest text-white shadow-lg shadow-primary/20 transition-all active:scale-95"
        >
